      ...
      <section className="section-tight">
        <div className="wrap">
          ...
          <div className="masonry-gallery">
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery21.JPG" alt="AI4All training activity" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery22.JPG" alt="AI4All participants in discussion" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery23.JPG" alt="AI4All workshop participants" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery24.JPG" alt="AI4All classroom activity" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery25.JPG" alt="AI4All learning session" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/gallery26.JPG" alt="AI4All community workshop" /></div>
          </div>
        </div>
      </section>
