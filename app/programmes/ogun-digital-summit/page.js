...
function Speaker() {
  return (
    <div className="team-card">
      <div className="img-ph ratio-1x1 round"><img src="/img/speaker1.png" alt="" /></div>
      ...
      <section className="section-tight">
        <div className="wrap">
          ...
          <div className="masonry-gallery">
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/ODS.png" alt="summit crowd photo" /></div>
            <div className="img-ph" style={{ aspectRatio: '3/4' }}><img src="/img/ODS.png" alt="speaker portrait" /></div>
            <div className="img-ph" style={{ aspectRatio: '1/1' }}><img src="/img/ODS.png" alt="exhibition photo" /></div>
            <div className="img-ph" style={{ aspectRatio: '3/4' }}><img src="/img/ODS.png" alt="Networking photo" /></div>
            <div className="img-ph" style={{ aspectRatio: '4/3' }}><img src="/img/ODS.png" alt="Panel discussion photo" /></div>
            <div className="img-ph" style={{ aspectRatio: '1/1' }}><img src="/img/ODS.png" alt="Award / closing photo" /></div>
          </div>
        </div>
      </section>
